const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Cuban Badge - Adjust position for mobile */}
      <div className="absolute top-16 right-4 sm:top-24 sm:right-8 md:top-60 md:right-125 w-24 h-24 md:w-32 md:h-32 z-20">
        {/* Glow effect */}
      ...
      {/* Left Side: Text Content - Center text on mobile */}
      <div className="max-w-lg z-10 text-center md:text-left mt-40 md:mt-16 order-1 md:order-none">
